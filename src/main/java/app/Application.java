...
class BookRestController {
    ...
    @Autowired
    BookRestController(BookRepository bookRepository, AccountRepository accountRepository) {
    ...
    ResponseEntity<?> add(@PathVariable String userId, @RequestBody Book input) {
        ...
        return this.accountRepository
                ...
                .map(account -> {
                    bookRepository.save(new Book(account, input.getName(),
                            input.getAuthor(), "description"));
